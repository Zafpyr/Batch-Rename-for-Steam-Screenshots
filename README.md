...
## About
Ever taken screenshots of a game not with steam's built-in screenshot function and wanted to upload them to steam but didn't know how or the process was too tedious, well the script(s) in this repo will allow you do just that, provided the screenshots are in jpg format, which can be done in bulk with various software such as Adobe Lightroom. 
